							...
							<ul class="menu-nav">
                                ...
                                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                    <a href="javascript:;" class="menu-link menu-toggle">
                                        ...
                                        <span class="menu-text">Customize Front page</span>
                                    ...
                                    <div class="menu-submenu" kt-hidden-height="200" style="display: none; overflow: hidden;">
                                        ...
                                        <ul class="menu-subnav">
                                            ...
                                            <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'Slide Show form'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                                <a  href="{{route('slide-form',1)}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                                    ...
                                                    <span class="menu-text">Slide show</span>
                                                </a>
                                            </li>
                                            <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'Flash Sale form'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                                <a  href="{{route('slide-form',2)}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                            ...
                                            <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'Top Products form'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                                <a  href="{{route('slide-form',3)}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                            ...
                                            <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'Best Sellers form'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                                <a  href="{{route('slide-form',4)}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                            ...
                                            <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'featured products form'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                                <a  href="{{route('slide-form',5)}}" class="menu-link">
                                                    <span class="svg-icon menu-icon">
                                ...
                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'categories'){echo 'menu-item-active'; }?>" aria-haspopup="true">
...
{{--                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'styles'){echo 'menu-item-active'; }?>" aria-haspopup="true">--}}
...
{{--                                </li>--}}
                                ...
                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'products'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                    <a  href="{{ route('products.index') }}" class="menu-link">
                                      <span class="svg-icon menu-icon">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                          <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Cart1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'orders'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                    <a  href="{{ route('orders.index') }}" class="menu-link">
                                      <span class="svg-icon menu-icon">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x">
                                         <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Bag2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                ...
                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'processed orders'){echo 'menu-item-active'; }?>" aria-haspopup="true">
                                    <a  href="{{ route('admin.processedindex') }}" class="menu-link">
                                      <span class="svg-icon menu-icon">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M4.26193932,17.6476484 C3.90425297,18.0684559 3.27315905,18.1196257 2.85235158,17.7619393 C2.43154411,17.404253 2.38037434,16.773159 2.73806068,16.3523516 L11.2380607,6.35235158 C11.6013618,5.92493855 12.2451015,5.87991302 12.6643638,6.25259068 L17.1643638,10.2525907 C17.5771466,10.6195087 17.6143273,11.2515811 17.2474093,11.6643638 C16.8804913,12.0771466 16.2484189,12.1143273 15.8356362,11.7474093 L12.0997854,8.42665306 L4.26193932,17.6476484 Z" fill="#000000" fill-rule="nonzero" transform="translate(9.999995, 12.000002) rotate(-180.000000) translate(-9.999995, -12.000002) "/>
                                ...
                                <li class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'admins'){echo 'menu-item-active'; }?>" aria-haspopup="true">
