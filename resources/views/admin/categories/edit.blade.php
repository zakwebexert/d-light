    ...
    <div class="d-flex flex-column-fluid">
      ...
      <div class="container">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          ...
          <!--begin::Form-->
            {{ Form::model($category, [ 'method' => 'PATCH','route' => ['categories.update', $category->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                  ...
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-9">
                              <img src="{{ asset('productImage/'.$category->image)}}" alt="profile Pic" height="200" width="200">
                          </div>
                      </div>
