...
{{--	      </div>--}}
    ...
    <div class="card-body">
      ...
      <div>
	      <form action="{{route('admin.delete-selected-categories')}}" method="post" id="client_form">
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.categorydetail') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
