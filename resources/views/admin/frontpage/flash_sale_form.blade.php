                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    ...
                    @include('admin.partials._messages')
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    <h3 class="text-dark font-weight-bold mb-10">Add items to Flash sale </h3>

                                    <div id="items_container_flash">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-9">
                                            <a onclick="myFlashSale()" href="javascript:void(0);" class="btn btn-icon btn-light-success btn-circle btn-sm mr-2">
...
@section('scripts')
    ...
    <script>
        ...
        function myFlashSale() {
            ...
            $('#items_container_flash').append(html);
            $('.kt_select2_2, .kt_select2_2_validate').select2({
                placeholder: 'Select items'
            });
