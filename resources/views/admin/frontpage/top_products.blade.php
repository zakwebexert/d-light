                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="" class="text-muted">Add Products to Top Products</a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    ...
                    @include('admin.partials._messages')
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    <h3 class="text-dark font-weight-bold mb-10">Add items to Top Products </h3>

                                    <div id="items_container_top_products">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-9">
                                            <a onclick="myTopProducts()" href="javascript:void(0);" class="btn btn-icon btn-light-success btn-circle btn-sm mr-2">
...
@section('scripts')
    ...
    <script>
        ...
        function myTopProducts() {
            ...
            $('#items_container_top_products').append(html);
            $('.kt_select2_2, .kt_select2_2_validate').select2({
                placeholder: 'Select items'
            });
