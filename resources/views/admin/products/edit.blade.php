    ...
    <div class="d-flex flex-column-fluid">
      ...
      <div class="container">
        ...
        <div class="card card-custom card-sticky" id="kt_page_sticky_card">
          ...
          <!--begin::Form-->
            {{ Form::model($product, [ 'method' => 'PATCH','route' => ['products.update', $product->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
              @csrf
              <div class="row">
                ...
                <div class="col-xl-8">
                  <div class="my-5">
                    ...
                    <div class="form-group row {{ $errors->has('name') ? 'has-error' : '' }}">
                      ...
                      <div class="col-9">
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Product Name','required'=>'true']) }}
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                      </div>
                    </div>


                      <div class="form-group row {{ $errors->has('product_desc') ? 'has-error' : '' }}">
                          <label class="col-3">Description
                          </label>
                          <div class="col-9">
                              {{ Form::text('product_desc', null, ['class' => 'form-control form-control-solid','id'=>'name','placeholder'=>'Enter Description','required'=>'true']) }}
                      ...
                      <div class="form-group row {{ $errors->has('category') ? 'has-error' : '' }}">
                          ...
                          <div class="col-9">
                              <select class="form-control" id="kt_select2_1" name="category" required='true'>
                      ...
                      <div class="form-group row">
                          <label class="col-3">pre image
                          </label>
                          <div class="col-9">
                              <img src="{{ asset('productImage/'.$product->image)}}" alt="profile Pic" height="200" width="200">
                          </div>
                      </div>
